      ...
      <div className="flex flex-col gap-5 p-5 w-screen order-2 sm:order-2">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="flex items-center justify-center mb-3">
            <Archive className="h-18 w-18 text-blue-600 dark:text-blue-400" />
            <h1 className="text-3xl sm:text-4xl font-extrabold  tracking-tight">
              ZIP File Compressor – Compress Files Online Without Quality Loss
            </h1>
          </div>
          <p className="dark:text-slate-400 text-sm sm:text-base">
        ...
        <div className="flex justify-center mb-6">
          <label className="cursor-pointer px-6 py-3 bg-indigo-600  hover:bg-indigo-400 text-white rounded-full font-semibold flex items-center gap-2 shadow-md hover:shadow-lg transition-all">
        ...
        {files.length > 0 ? (
          <motion.div
            layout
            className="mb-6 border border-gray-300 rounded-xl p-4 max-h-64 overflow-y-auto shadow-inner"
          >
        ...
        <div className="flex justify-center mb-6">
          <button
            ...
            className={`px-8 py-3 text-lg rounded-full font-semibold text-white flex items-center gap-2 shadow-md transition-all ${compressing
        ...
        {message && (
          <div
            className={`text-center text-sm font-medium mb-6 ${message.startsWith("✅")
