    ...
    <div className="mt-20 flex flex-col mb-5 sm:flex-row">
      <div className="order-2 w-screen dark:bg-slate-950 rounded-2xl p-6 sm:order-2">
        ...
        <textarea
          ...
          className="w-full min-h-40 shadow-2xl sm:min-h-[220px] p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 resize-vertical"
        />
        ...
        <div className="mt-6 text-xs text-gray-500">Tips: Use <code className="dark:bg-slate-900 px-1 rounded">Strip HTML Tags</code> when pasting content from web pages. <br />Use <code className="dark:bg-slate-900 px-1 rounded">Convert To Single Line</code> for CSV or single-line formats.</div>
      </div>
      {/* Here Moblie card */}
