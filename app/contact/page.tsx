...
export default function ContactPage() {
    return (
        <>
            {/* ==== HERO SECTION ==== */}
            <section className="relative bg-linear-to-br from-blue-900 via-indigo-800 to-purple-900 text-white overflow-hidden">
                <div className="absolute inset-0 bg-black opacity-40"></div>
                <div className="absolute inset-0">
                    <div className="absolute top-10 left-10 w-80 h-80 bg-cyan-500 rounded-full mix-blend-multiply blur-3xl opacity-20 animate-pulse"></div>
                    <div className="absolute bottom-10 right-10 w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply blur-3xl opacity-20 animate-pulse animation-delay-2000"></div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="space-y-8">
                            <h2 className="text-3xl font-bold text-gray-800 animate-fade-in animation-delay-400">
                                Contact Information
                            </h2>

                            <div className="space-y-6">
                                {[
                                    { icon: <Mail className="w-6 h-6" />, label: 'Email', value: 'support@a2tool.com', href: 'mailto:support@a2tool.com' },
                                    ...
                                    <a
                                        key={i}
                                        href={item.href}
                                        className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 animate-slide-up group"
                        ...
                        {/* Contact Form */}
                        <div className="bg-white p-8 rounded-2xl shadow-xl animate-fade-in animation-delay-800">
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 animate-fade-in animation-delay-1000">
                        Powerful PDF, Image & Text Utilities
                    </h2>

                    <p className="text-lg text-gray-600 leading-relaxed mb-8 animate-slide-up animation-delay-1200">
                        A2Tool provides a complete suite of developer‑friendly utilities: <strong>PDF merge / split / compress</strong>,{' '}
                    ...
                    <a
                        href="/tools"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-cyan-500 text-white font-semibold rounded-full hover:bg-cyan-600 transition-colors animate-fade-in animation-delay-1400"
                    >
